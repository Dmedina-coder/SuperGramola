...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        navegador.esperar(3);
        Pruebas.FormularioLogin(navegador);
        navegador.hacerClicPorSelector("body > app-root > div > app-login > div > div > div > div.modal-body > button");
        ...
        // Probar búsqueda de canciones y añadir a la cola
        navegador.esperar(3);
        Pruebas.Gramola(navegador);
